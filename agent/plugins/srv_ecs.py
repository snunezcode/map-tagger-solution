...
####----| Info method
def info():
    return (json.dumps({ "id" : "m010", "service" : "ecs", "sub_service" : "ecs", "description" : "AWS Service ECS", "version" : "1.0.0", "date" : "2024-09-10" }))
    ...
    try:
        ...
        for page in paginator.paginate():
            ...
            for resource in resource_list:
                    ...
                    tags = tagger.tag_key_convertion(tags,'key','value')
                    ...
                    if not tagger.tag_exists(tags):
                        ...
                        action = "1"
                    resources.append({ "process_id" : tagger.process_id, "account" : account, "region" : region, "service" : service_info["sub_service"], "type" : action, "identifier" : identifier, "resource_name" : resource_name, "arn" : arn, "tag_key" : tagger.tag_key , "tag_value" : tagger.tag_value, "created" : create_time, "tags" : json.dumps(tags) })
